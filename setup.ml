...
(* OASIS_START *)
(* DO NOT EDIT (digest: e505a8598ae1a9f37748fba5f0491bd7) *)
(*
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = ["Stanislav Artemkin <artemkin@gmail.com>"];
          authors = ["Stanislav Artemkin"];
          homepage = Some "https://github.com/artemkin/git-lfs-server";
          synopsis = "Git Large File Storage (LFS) server";
          description =
            Some
              [
                 OASISText.Para
          ...
          files_ab = ["src/lfs_config.ml.ab"];
          sections =
            [
               Executable
                 ({
                     cs_name = "git-lfs-server";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("cohttp.async",
                               Some (OASISVersion.VGreaterEqual "0.17.1"));
                   ...
                   {exec_custom = false; exec_main_is = "lfs_server.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/artemkin/git-lfs-server.git";
                      src_repo_browser =
                        Some "https://github.com/artemkin/git-lfs-server";
